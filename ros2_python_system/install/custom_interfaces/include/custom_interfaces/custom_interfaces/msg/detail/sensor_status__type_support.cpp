...
{
  new (message_memory) custom_interfaces::msg::SensorStatus(_init);
}

void SensorStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::msg::SensorStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SensorStatus_message_member_array[4] = {
  {
    ...
    offsetof(custom_interfaces::msg::SensorStatus, left_ir),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::SensorStatus, right_ir),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::SensorStatus, front_ir),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::msg::SensorStatus, front_us),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SensorStatus_message_members = {
  ...
  4,  // number of fields
  sizeof(custom_interfaces::msg::SensorStatus),
...
get_message_type_support_handle<custom_interfaces::msg::SensorStatus>()
{
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::SensorStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, msg, SensorStatus)() {
  return &::custom_interfaces::msg::rosidl_typesupport_introspection_cpp::SensorStatus_message_type_support_handle;
}
