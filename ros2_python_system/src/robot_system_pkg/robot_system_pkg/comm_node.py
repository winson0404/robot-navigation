...
class CommNode(Node):
    ...
    def predefined_path(self)->List[Tuple[float, float, int]]:
        ...
        decision_map = {
            ...
            constant.DECISION_MOVE_FRONT_SMALL: (velocity, 0.0, 200),
            constant.DECISION_MOVE_FRONT_BIG: (velocity, 0.0, 1000),
            constant.DECISION_MOVE_FRONT_VERY_BIG: (velocity, 0.0, 5000),
            constant.DECISION_ULTRA_SMALL_ROTATE_COUNTER_CLOCKWISE: (0.0, small_counter_clockwise_radian, 100),
            constant.DECISION_ULTRA_SMALL_ROTATE_CLOCKWISE: (0.0, small_clockwise_radian, 100),
        ...
        if self.map == constant.MAP1:
            ...
            if self.destination == constant.DESTINATION1:
                return [
                        decision_map[constant.DECISION_MOVE_FRONT_VERY_BIG], 
                        decision_map[constant.DECISION_ULTRA_SMALL_ROTATE_COUNTER_CLOCKWISE], 
                        decision_map[constant.DECISION_MOVE_FRONT_VERY_BIG], 
                        decision_map[constant.DECISION_BIG_ROTATE_CLOCKWISE], 
                        decision_map[constant.DECISION_BIG_ROTATE_CLOCKWISE], 
                        decision_map[constant.DECISION_MOVE_FRONT_BIG]
                    ]
            else:
                return [
                        decision_map[constant.DECISION_BIG_ROTATE_CLOCKWISE], 
