...
VELOCITY_PERIOD = 100 # milliseconds
...
DECISION_BIG_ROTATE_COUNTER_CLOCKWISE = 6
DECISION_BIG_ROTATE_CLOCKWISE = 7
DECISION_BIG_ROTATE_BOTH_DIRECTION = 8
DECISION_MOVE_FRONT_SMALL = 9
DECISION_ULTRA_SMALL_ROTATE_COUNTER_CLOCKWISE = 10
DECISION_ULTRA_SMALL_ROTATE_CLOCKWISE = 11
DECISION_MOVE_FRONT_BIG = 12
DECISION_MOVE_FRONT_VERY_BIG = 13